...
<head>
<meta charset="utf-8">
<title>无标题文档</title><div class="circle">
  <div class="moon"></div>
  <div class="moon2"></div>
...
.rabbit {
  ...
  left: 33%;
  position: absolute;
  border-radius: 52% 48% 47% 53% / 69% 70% 30% 31%;
}
.ear1 {
  position: absolute;
  background: #D7DDE8;
...
.cloud1 {
  ...
  border-radius: 50px;
  opacity: 0.5;
  animation: 5s linear infinite slidein;
}
.cloud2 {
  background: black;
  position: absolute;
  ...
  border-radius: 50px;
  opacity: 0.5;
  animation: 7s reverse infinite slidein;
}
.cloud3 {
  background: white;
  position: absolute;
...
.cloud4 {
  ...
  border-radius: 50px;
  opacity: 0.5;
  animation: 5s reverse infinite slidein;
}
@keyframes slidein {
  from {
